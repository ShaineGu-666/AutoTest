 ...
 **/
public class TC05_发布作业到多个常用班级在线提交不允许互看 extends WechatBase {

    @Test
    public void verifyTc05() throws Exception {
...
//选择一周后的日期
        ...
        homeworkManagementPage.verifyDisplayed();
        homeworkManagementPage.verifyPublishedHomeWorkSection(true);
